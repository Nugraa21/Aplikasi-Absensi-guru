...
class _AttendancePageState extends State<AttendancePage> {
  ...
  bool loading = false;
  // center point SMK N 2 Yogyakarta (example), radius 1km
  ...
  Future<void> _takeAndSaveAttendance() async {
    ...
    if (pos == null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Lokasi tidak tersedia / izin belum diberikan"),
        ),
      );
      return;
    }
    ...
    if (dist > maxDistance) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            "Anda di luar area (${(dist / 1000).toStringAsFixed(2)} km)",
          ),
        ),
      );
      return;
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            children: [
              const Text(
                "Tekan tombol untuk selfie dan mengirim absensi (menunggu konfirmasi admin).",
              ),
